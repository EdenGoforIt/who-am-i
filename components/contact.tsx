...
export default function Contact(): React.JSX.Element {
  return (
    ...
    >
      ...
      >
        <p className="font-mono text-sm mb-4 text-green">05. What&apos;s Next?</p>
        <h2 className="text-5xl font-semibold mb-5 text-slate-lighter">Get In Touch</h2>
        ...
        <div className="flex items-center justify-center gap-6 mt-12">
          <a
            ...
            aria-label="GitHub"
            className="text-slate-light transition-colors duration-300 hover:opacity-80"
          >
            <GitHubIcon />
          </a>
          <a
      ...
      <footer className="mt-20 text-center">
        <p className="font-mono text-xs text-slate">Designed &amp; Built by Eden Park.</p>
      </footer>
    </section>
  );
}

...
const achievements: Achievement[] = [
  ...
  {
    icon: <UsersIcon />,
    text: "Praised by four peers and the tech lead as the best developer, team member, and mentor on the team.",
  },
  {
    icon: <ShieldIcon />,
  ...
  {
    icon: <RocketIcon />,
    text: "Became a senior engineer after just 2.5 years — well ahead of the typical career progression.",
  },
  {
    icon: <ZapIcon />,

      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3 space-y-4 text-slate">
            <p>
              I&apos;m Eden — a software engineer who cares deeply about the craft of building
            ...
            <p>
              I&apos;m drawn to Domain-Driven Design as a way to bridge the gap between business
              complexity and technical implementation. I think carefully about bounded contexts,
              aggregates, and domain models — designing systems where the code reflects the language
              of the problem, not just the mechanics of the solution. When the domain model is
              right, everything else tends to fall into place.
            </p>
            <p>
              At the architectural level, I apply patterns like layered architecture,
            ...
            <p>
              Beyond the code itself, I value rigorous testing (unit, integration, contract),
